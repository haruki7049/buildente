 ...
 *
 * <p>Steps form a directed acyclic graph (DAG). When {@link #make()} is called,
 * all dependencies are executed first (post-order traversal), guaranteeing that
 * each step runs exactly once per build invocation.
 *
...
public abstract class Step {
    ...
    /**
     * Declares that this step depends on another step.
     * The dependency will be executed before this step.
     *
     ...
     *
     * <p>Dependencies are resolved depth-first. This method is idempotent:
     * calling it multiple times on the same step has no additional effect.
     */
    ...
    /**
     * Contains the actual work performed by this step.
